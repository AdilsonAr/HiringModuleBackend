...
class AdminAccessTest {
	...
	@Test
	@DisplayName("Este test pasa si un ADMIN puede hacer GET a /proceso")
	...
	@Test
	@DisplayName("Este test pasa si un ADMIN puede hacer POST a /proceso")
	@WithMockUser(roles = "ADMIN")
	...
	@Test
	@DisplayName("Este test pasa si un ADMIN puede hacer PUT a /proceso")
	@WithMockUser(roles = "ADMIN")
	...
	@Test
	@DisplayName("Este test pasa si un ADMIN puede hacer DELETE a /proceso")
	@WithMockUser(roles = "ADMIN")
	void deleteToProcesoAsAsesor() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.delete("/proceso?id=1")
	            .accept(MediaType.ALL))
	            .andExpect(status().isOk());
	}
	
	@Test
	@DisplayName("Este test pasa si un ADMIN puede hacer PUT a /aplicacion")
	@WithMockUser(roles = "ADMIN")
	void aceptAsAsesor() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.put("/aplicacion/acept?id_aplicacion=26")
	            .accept(MediaType.ALL))
	            .andExpect(status().isOk());
	}
